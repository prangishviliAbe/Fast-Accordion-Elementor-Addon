...
function fast_accordion_enqueue_styles() {
	wp_enqueue_style( 'fast-accordion-style', plugins_url( 'assets/css/style.css', __FILE__ ), array(), '1.0.4' );
	wp_enqueue_script( 'fast-accordion-script', plugins_url( 'assets/js/script.js', __FILE__ ), array('jquery'), '1.0.4', true );
}
